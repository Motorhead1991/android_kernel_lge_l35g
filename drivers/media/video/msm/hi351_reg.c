...
struct hi351_i2c_reg_conf hi351_reg_settings[] = {
	...
	{0x60, 0xff, BYTE_LEN}, //mcmc steve MCMC ON 20111221 
  ...
  {0xF0, 0x01, BYTE_LEN},//Pre WB gain enable Gain resolution_1x	STEVE LOW
	...
	{0x12, 0x6d, BYTE_LEN}, // STEVE Dgain ON for Low Light Spec. (2d -) 6d)
	{0x17, 0xa0, BYTE_LEN},
	{0x1f, 0x1f, BYTE_LEN},
	...
	{0x51, 0xF0, BYTE_LEN}, //pga_max_total A0 -) D0 STEVE
	{0x52, 0x28, BYTE_LEN}, //pga_min_total

	{0x71, 0xD0, BYTE_LEN}, //DG MAX 0x80 -) 0xD0 STEVE
	...
	{0x25, 0x01, BYTE_LEN},//ZOOM_WIN_STX_L 	 //STEVE01 DV3 fix 0x03 -)0x01
	{0x26, 0x00, BYTE_LEN},//ZOOM_WIN_STY_H 	 
	{0x27, 0x01, BYTE_LEN},//ZOOM_WIN_STY_L 	 
	{0x28, 0x02, BYTE_LEN},//ZOOM_WIN_ENX_H 	 
	{0x29, 0x81, BYTE_LEN},//ZOOM_WIN_ENX_L 	 //STEVE01 DV3 fix 0x83 -)0x81
	...
	{0x03, 0x20, BYTE_LEN},
	{0x12, 0x6d, BYTE_LEN}, //STEVE Dgain ON for Low Light Spec. (2d) 
  ...
  {0x20, 0x20, BYTE_LEN}, // STEVE Capture Hblank 288 -) 2180 + 288 one line 2468 
	...
	{0x39, 0xd0, BURST_TYPE}, // START Low temp angle move
	{0x3a, 0x00, BURST_TYPE},
...
//<A - init>
  ...
  {0xAB, 0x78, BURST_TYPE}, //
	...
	{0x10, 0xff, BYTE_LEN}, // STEVE 8f -) ff ALL ON :Ytar, Gam, CCM, Sat, LSC, MCMC , Yoffs, Contrast
...
struct hi351_i2c_reg_conf hi351_auto_framerate_settings[] = {
  ...
  { 0x16, 0xf8, BYTE_LEN},   
	...
	{ 0x03, 0xcf, BYTE_LEN}, //Adaptive On						   
	{ 0x10, 0xff, BYTE_LEN},  // STEVE all on                                     
	{ 0x03, 0xc0, BYTE_LEN}, 
	{ 0x33, 0x00, BYTE_LEN},
	{ 0x32, 0x01, BYTE_LEN}, //DMA On   	 
