...
static char *e0eu_gpio_earsense_print_name(int state)
{
	if (state)
		return "Headset";
	else
...
static char *e0eu_gpio_earsense_print_state(int state)
{
...
static int e0eu_gpio_earsense_sysfs_store(const char *buf, size_t size)
{
	int state;
...
static unsigned e0eu_earsense_gpios[] = {
	GPIO_EAR_SENSE,
};

/* especially to address gpio key */
static unsigned e0eu_hook_key_gpios[] = {
	GPIO_BUTTON_DETECT,
};

static int e0eu_gpio_hook_key_work_func(int *value)
{
	int gpio_value;
...
static struct lge_gpio_switch_platform_data e0eu_earsense_data = {
	.name = "h2w_headset",
	.gpios = e0eu_earsense_gpios,
	.num_gpios = ARRAY_SIZE(e0eu_earsense_gpios),
	.irqflags = IRQF_TRIGGER_RISING | IRQF_TRIGGER_FALLING,
	.wakeup_flag = 1,
	.work_func = e0eu_gpio_earsense_work_func,
	.print_name = e0eu_gpio_earsense_print_name,
	.print_state = e0eu_gpio_earsense_print_state,
	.sysfs_store = e0eu_gpio_earsense_sysfs_store,

	/* especially to address gpio key */
	.key_gpios = e0eu_hook_key_gpios,
	.num_key_gpios = ARRAY_SIZE(e0eu_hook_key_gpios),
	.key_work_func = e0eu_gpio_hook_key_work_func,
};

static struct platform_device e0eu_earsense_device = {
	.name	= "lge-switch-gpio",
	.id		= -1,
	.dev	= {
		.platform_data = &e0eu_earsense_data,
	},
};

/* input platform device */
static struct platform_device *e0eu_sound_devices[] __initdata = {
	&msm_device_snd,
	&msm_device_adspdec,
	&e0eu_earsense_device,
};
...
void __init lge_add_sound_devices(void)
{
	...
	platform_add_devices(e0eu_sound_devices, ARRAY_SIZE(e0eu_sound_devices));
}
