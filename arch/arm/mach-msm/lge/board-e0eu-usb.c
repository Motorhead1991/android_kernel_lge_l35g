...
module_param_call(act, diag_set_usb_lock_state, diag_get_usb_lock_state,
						&diag_lock_state, 0660);
MODULE_PARM_DESC(act, "act");
...
module_param_call(test, set_usb_lock_key, get_usb_lock_key,
						&diag_lock_key, 0660);
MODULE_PARM_DESC(test, "test");
...
#if 1 //lbh.lee@lge.com for adb devices setting fack number
static int __init board_serialno_setup(char *serialno)
{
	int i;
	char *src = serialno;
