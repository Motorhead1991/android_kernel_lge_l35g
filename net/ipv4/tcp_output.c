...
static __u16 tcp_advertise_mss(struct sock *sk)
{
	...
	// LGE_CHANGE_S, [Data_Patch_GB_US_02] [d3sw1-data@lge.com], 2012.01.15 <ATnT MTU size 1410 >
	#ifdef TARGET_CARRIER_E0TRF 
	mss = 1370;	
    tp->advmss = mss;
	#endif
	// LGE_CHANGE_E, [Data_Patch_GB_US_02] [d3sw1-data@lge.com], 2012.01.15 <ATnT MTU size 1410  >
			       ...
			       __u32 init_rcv_wnd)
{
	...
	if (wscale_ok) {
		 ...
		 */
// LGE_CHANGE_S, [LGE_DATA_US_066] d3sw1-data@lge.com, 2012-03-02 <TCP WINDOW SIZE SETTING FOR ATT, TRF>
		 #ifdef TARGET_CARRIER_E0TRF 
		 sysctl_rmem_max=204800;
	  	 #endif
// LGE_CHANGE_E, [LGE_DATA_US_066] d3sw1-data@lge.com, 2012-03-02 <TCP WINDOW SIZE SETTING FOR ATT, TRF>
