...
/* LGE_CHANGE_E [soonyong.kwon@lge.com] 2011-03-16, LG_TRF_SECURITY */
#ifdef CONFIG_LG_TRF_SECURITY
#include <linux/reboot.h>
#endif /*CONFIG_LG_TRF_SECURITY*/
/* LGE_CHANGE_E [soonyong.kwon@lge.com] 2011-03-16, LG_TRF_SECURITY */
#include <mach/irqs.h>
...
/* LGE_CHANGE_E [soonyong.kwon@lge.com] 2011-03-16, LG_TRF_SECURITY */
#ifdef CONFIG_LG_TRF_SECURITY
#define SECURITY_BINARY_CODE	35
#endif 
/* LGE_CHANGE_E [soonyong.kwon@lge.com] 2011-03-16, LG_TRF_SECURITY */
	...
	uint16		pkt_len )			  /* length of request packet	*/
{
	...
	printk(KERN_ERR "[TF Process] Function call\n");

	security_binary_code_received=1;

	if(req_ptr->seccode != SECURITY_BINARY_CODE)
	{
		printk(KERN_ERR " %s : kernel restart : Wrong security code!!\n", __func__);	
		kernel_restart(NULL);
	}	
